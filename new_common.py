...
def main():
    if st.session_state.user_email is None:
    ...
    elif st.session_state.user_email == "guest" and st.session_state.guest_tries <= 5:
        ...
        if not can_guest_detect():
            print("5 tries reached, make an account or log in.")
    ...
    if not history_df.empty:
        ...
        #         # Placeholder for history viewing functionality
